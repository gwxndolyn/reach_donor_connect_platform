  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-red-50 pt-20">
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* Welcome Header */}
        <div className="mb-8 bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20">
          ...
          {/* Hero stats bar */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 p-4 bg-gradient-to-r from-red-500/10 to-pink-500/10 rounded-xl border border-red-200/30">
            <div className="text-center">
              <div className="text-2xl font-bold text-red-600">${totalDonated > 0 ? totalDonated : '1,250'}</div>
              <div className="text-sm text-gray-600">Total Impact</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-pink-600">{uniqueChildren > 0 ? uniqueChildren : '3'}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div key={index} className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-white/30 hover:shadow-2xl transition-all duration-300 hover:scale-105">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {supportedChildren.slice(0, 2).map((child, index) => (
                  <div key={index} className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-xl p-6 hover:shadow-lg hover:scale-105 transition-all duration-300">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-16 h-16 rounded-full overflow-hidden ring-2 ring-pink-200 shadow-lg">
                        <Image
                          src={child.image}
                          alt={child.name}
                          width={64}
                    ...
                    <div className="space-y-3">
                      <p className="text-sm text-gray-600 bg-blue-50 p-3 rounded-lg border-l-4 border-blue-400">{child.progress}</p>
                      <div className="flex items-center justify-between bg-green-50 p-3 rounded-lg">
                        <span className="text-sm font-medium text-green-700">Your total support</span>
                        <span className="font-bold text-green-600 text-lg">{child.totalDonated}</span>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Your Impact This Month</h2>
              </div>
              
              <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 rounded-xl p-6 border border-gradient-to-r from-blue-200 to-pink-200 shadow-inner">
                <div className="flex items-center gap-4 mb-4">
                ...
                <p className="text-sm text-blue-600 bg-white/50 p-4 rounded-lg shadow-sm">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 p-6">
              ...
              <div className="space-y-4">
                {recentActivity.map((activity, index) => (
                  <div key={index} className="flex items-start gap-4 pb-4 last:pb-0 border-b border-gray-100 last:border-0 hover:bg-gray-50/50 p-3 rounded-lg transition-colors">
