      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20 dark:border-gray-700/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 p-4 bg-gradient-to-r from-red-500/10 to-pink-500/10 dark:from-red-500/20 dark:to-pink-500/20 rounded-xl border border-red-200/30 dark:border-red-600/30">
            <div className="text-center">
              <div className="text-2xl font-bold text-red-600 dark:text-red-400">${totalDonated > 0 ? totalDonated : '1,250'}</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">Total Impact</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-pink-600 dark:text-pink-400">{uniqueChildren > 0 ? uniqueChildren : '3'}</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">Children Supported</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">6 months</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div key={index} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-white/30 dark:border-gray-700/30 hover:shadow-2xl transition-all duration-300 hover:scale-105">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 dark:border-gray-700/30 p-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Children You Support</h2>
                </div>
                <Link 
                  href="/children" 
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {supportedChildren.slice(0, 2).map((child, index) => (
                  <div key={index} className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-700 dark:to-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl p-6 hover:shadow-lg hover:scale-105 transition-all duration-300">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">{child.age} years old • {child.location}</p>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <p className="text-sm text-gray-600 dark:text-gray-300 bg-blue-50 dark:bg-blue-900/30 p-3 rounded-lg border-l-4 border-blue-400 dark:border-blue-500">{child.progress}</p>
                      <div className="flex items-center justify-between bg-green-50 dark:bg-green-900/30 p-3 rounded-lg">
                        <span className="text-sm font-medium text-green-700 dark:text-green-300">Your total support</span>
                        <span className="font-bold text-green-600 dark:text-green-400 text-lg">{child.totalDonated}</span>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 dark:border-gray-700/30 p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Your Impact This Month</h2>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 dark:from-blue-900/30 dark:via-purple-900/30 dark:to-pink-900/30 rounded-xl p-6 border border-gradient-to-r from-blue-200 to-pink-200 dark:from-blue-600 dark:to-pink-600 shadow-inner">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900 dark:text-blue-100">School Supplies Delivered</h3>
                    <p className="text-blue-700 dark:text-blue-300">Your donations helped purchase supplies for 15 children</p>
                  </div>
                </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 dark:border-gray-700/30 p-6">
              ...
              <div className="space-y-4">
                {recentActivity.map((activity, index) => (
                  <div key={index} className="flex items-start gap-4 pb-4 last:pb-0 border-b border-gray-100 dark:border-gray-700 last:border-0 hover:bg-gray-50/50 dark:hover:bg-gray-700/50 p-3 rounded-lg transition-colors">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${activity.color} shadow-sm`}>
