            ...
            <div className="bg-white rounded-3xl shadow-2xl p-12">
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h1 className="text-4xl font-bold text-gray-900">Welcome, {successName}!</h1>
                  <Sparkles className="h-6 w-6 text-yellow-500" />
                </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 mb-8">
                ...
                <div className="space-y-4 text-left">
                  <div className="flex items-center gap-4">
                    ...
                    <p className="text-gray-700">Browse children in need of support</p>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-white font-semibold text-sm">2</span>
                    </div>
                    <p className="text-gray-700">Choose a child to sponsor and make your first donation</p>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-white font-semibold text-sm">3</span>
                    </div>
                    <p className="text-gray-700">Receive updates and build meaningful connections</p>
                  </div>
                </div>
              </div>
      ...
      <div className="w-full max-w-lg mx-auto">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-blue-600">Complete profile</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-gray-500">Start giving</span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
          ...
          >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  name="region"
                  required
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none transition-colors text-gray-900 appearance-none bg-white"
                  defaultValue=""
                >
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-3 px-4 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-indigo-800 focus:ring-4 focus:ring-blue-200 focus:outline-none transition-colors !transform-none !scale-100 hover:!scale-100 active:!scale-100 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isPending ? (
                <>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            ...
            <span className="font-semibold text-gray-700">500+ donors</span> making a difference
          </p>
        </div>
      </div>
    </div>
